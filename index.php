...
<body>
	...
	<div class="header">
		<div class="logo"><img class="logo" src="images/logo-white.png" alt=""></div>
		<div class="space"></div>
	...
	<div class="main">
		<div class="includes">
			<div class="images"><img class="imgprize" src="images/1.png" alt=""></div>
			<div class="textprize">Лучший проект</div>
			<div class="prize">50 000 ТЕҢГЕ</div>
		</div>
		<div class="includes">
			<div class="images"><img class="imgprize" src="images/2.png" alt=""></div>
			<div class="textprize">Лучший функционал</div>
			<div class="prize">30 000 ТЕҢГЕ</div>
		</div>
		<div class="includes">
			<div class="images"><img class="imgprize" src="images/3.png" alt=""></div>
